...
/// the version identifies is the published contract — the OpenAPI document and the name it is
/// served under — so a reader can tell which description of the API they are holding.
///
